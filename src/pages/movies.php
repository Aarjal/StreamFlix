...
$pageDescription = 'Browse the StreamFlix collection - filter by genre, search titles, and discover your next favorite movie.';
...
<body class="movies-page" data-page="movies">
    ...
    <main id="main-content" class="movies-section">
        ...
        <div id="movie-active-filters" class="movie-active-filters" hidden>
            <span class="movie-active-filters__label">Active filters</span>
            <div id="movie-filter-chips" class="movie-filter-chips" aria-live="polite"></div>
            <button type="button" class="movie-filter-clear" id="movie-filter-chips-clear">Clear all</button>
        </div>
